...
| [[_ocaml_module_name]]name
|  A unique name for this target. | +++<a href="https://bazel.build/concepts/labels#target-names">Name</a>+++
| required
| 
| [[_ocaml_module_deps]]deps
|  List of dependencies. May include C/C++ libraries produced by https://github.com/bazelbuild/rules_cc[rules_cc]. | +++<a href="https://bazel.build/concepts/labels">List of labels</a>+++
| optional
| []
| [[_ocaml_module_data]]data
...
| optional
| {}
| [[_ocaml_module_deps_runtime]]deps_runtime
...
| optional
| []
| [[_ocaml_module_ppx_print]]ppx_print
...
| optional
| None
| [[_ocaml_module_ppx_verbose]]ppx_verbose
|  - | +++Boolean+++
| optional
| False
| [[_ocaml_module_sig]]sig
