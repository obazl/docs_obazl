...
[.prototype]
pass:[
ocaml_library(<a href="#ocaml_library-name">name</a>, <a href="#ocaml_library-archive_name">archive_name</a>, <a href="#ocaml_library-env">env</a>, <a href="#ocaml_library-linkage">linkage</a>, <a href="#ocaml_library-manifest">manifest</a>, <a href="#ocaml_library-ns_name">ns_name</a>, <a href="#ocaml_library-opts">opts</a>, <a href="#ocaml_library-shared">shared</a>, <a href="#ocaml_library-standalone">standalone</a>)
]
